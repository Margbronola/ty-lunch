...
class CustomAuth {
  ...
  Future<String?> create({
    ...
    try {
      ...
      if (e.code == 'user-not-found') {
        showError(msg: "Aucun utilisateur trouvé");
      } else if (e.code == 'wrong-password') {
        showError(msg: "Mot de passe incorrect");
      } else if (e.code == "email-already-in-use") {
        showError(msg: "Email déjà utilisé");
        ...
        showError(msg: "Mot de passe faible");
      }
      return null;
    } on SocketException {
      showError(msg: "Pas de connexion Internet");
      return null;
    } on HttpException {
      showError(
      ...
      showError(msg: "Erreur de format");
      return null;
    } on TimeoutException {
      showError(msg: "Pas de connexion Internet : timeout");
      return null;
    }
  }
  ...
  Future<String?> signIn({
    ...
    try {
      ...
      showError(msg: "Erreur de format: $e");
      return null;
    } on TimeoutException {
      showError(msg: "Pas de connexion Internet : timeout");
      return null;
