                                        ...
                                        if (loggedUser!.company.deliveryType ==
                                          ...
                                          menu1[i].menu!.isEmpty
                                              ...
                                              : weekDate = DateFormat(
                                                ...
                                                DateTime.parse(
                                                  menu1[i].menu!.first.schedule,
                                                ),
                                              );

                                          final List<ProductModel> starter =
                                          ...
                                          final List<ProductModel> surLePouce =
                                              menus.details.categories
                                                  .where(
                                                    (element) =>
                                                        element.name.contains(
                                                                            ...
                                                                            builder:
                                                                                (
                                                                                  ...
                                                                                  menu:
                                                                                      result.menus![i],
                                                                                  date: DateTime.parse(
                                                                                    result.menus![i].menu![0].schedule,
                                                                                  ),
                                                                                ),
                                                                          ),
                                                                        );
                                    ...
                                    itemBuilder: (c, q) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemBuilder: (c, m) {
                                          ...
                                          weekDate1 = DateFormat(
                                            'EEEE',
                                            'fr_FR',
                                          ).format(
                                            DateTime.parse(
                                              menu1[q].menu!.first.schedule,
                                            ),
                                          );
