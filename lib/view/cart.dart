                                                                        ...
                                                                        return Column(
                                                                          children: [
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                SizedBox(
                                                                                  width:
                                                                                      70,
                                                                                  child: Text(
                                                                                    "${data.remapFormula?[q].amount.toStringAsFixed(2)} €",
                                                                                    style: const TextStyle(
                                                                                      fontSize:
                                                                                          16,
                                                                                      fontWeight:
                                                                            ...
                                                                            ListView.builder(
                                                                              ...
                                                                              itemCount:
                                                                                  data.remapFormula![q].categories.length,
                                                                              itemBuilder: (
                                                                                c,
                                                                                x,
                                                                              ) {
                                                                                category =
                                                                                    data.remapFormula![q].categories;
                                                                                            ...
                                                                                            GestureDetector(
                                                                                              onTap: () {
                                                                                                ...
                                                                                                for (final CartProduct cprod in cart[i].products) {
                                                                                                  if (cprod.productId ==
                                                                                                      data.remapFormula![q].categories[x].prodId) {
                                                                                                    cartProduct =
                                                                                                        cprod;
                                                                                                    print(
                                                                                                      ...
                                                                                                      for (final RemapIndividualModel remapIndi in data.remapIndividual!) {
                                                                                                        if (cartProduct.productId ==
                                                                                                          ...
                                                                                                          individualQty =
                                                                                                              remapIndi.qty;
                                                                                                          print(
                                                                                                            "mayda individual $individualQty",
                                                                                                          );
                                                                                                          categoryQty =
                                                                                                              individualQty;
                                                                                                        }
                                                                                                ...
                                                                                                print(
                                                                                                  "CATEGORY QTY: $categoryQty",
                                                                                                );
                                                                                                print(
                                                                                                  "REMAP QTY: ${data.remapFormula![q].qty} - INDIVIDUAL QTY: $individualQty",
                                                                                                );
                                                                                                print(
                                                                                                  "PRODUCTTT STOCK ON CART PAGE: ${prod.dishName} -  ${prod.stock}",
                                                                                                );
                                                                    ...
                                                                    : Column(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        ListView.builder(
                                                                          ...
                                                                          itemCount:
                                                                              data.remapIndividual!.length,
                                                                          itemBuilder: (
                                                                            c,
                                                                            x,
                                                                          ) {
                                                                            final RemapIndividualModel
                                                                            indi =
                                                                                data.remapIndividual![x];
                                                                            ...
                                                                            for (final ProductModel
                                                                              ...
                                                                              if (prod.id ==
                                                                                ...
                                                                                prodStock =
                                                                                    prod.stock;
                                                                                print(
                                                                                  "PROD STOCK IN INDIVIDUAL: $prodName - ${prod.stock} - ${prod.dishName}",
                                                                                );
                                                                              }
                                                                            }
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    GestureDetector(
                                                                                      onTap: () {
                                                                                              ...
                                                                                              for (final RemapFormulaModel remapFormula in data.remapFormula!) {
                                                                                                for (final CategoriesModel category in remapFormula.categories) {
                                                                                                  if (prod.productId ==
                                                                                                    ...
                                                                                                    print(
                                                                                                      "REMAP FORMULA QTY: $remapqty",
                                                                                                    );
                                                                                                    print(
                                                                                                      "INDIVIDUAL QTY: ${data.remapIndividual![x].qty}",
                                                                                                    );
                                                                                                  }
                                                                                                }
                                                                                              }
                                                                                        ...
                                                                                        print(
                                                                                          "PRODUCTTT STOCK ON CART PAGE: ${prodStock}",
                                                                                        );
